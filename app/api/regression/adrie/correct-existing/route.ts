...
/**
 * Temporary fail-closed gate. The old handler used an adapter correction
 * function after same-origin and client-supplied version checks. Such checks
 * are not owner authorization or a durable one-shot claim.

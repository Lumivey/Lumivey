...
const SPECS: AssetSpec[] = [
  {
    ...
    purpose: "supporting",
    source: "Artistieke productie-asset op basis van de goedgekeurde Preview. Concept voor het vader/Porsche-oorsprongsverhaal; vóór publicatie met Michael valideren of vervangen door echte familiefoto.",
    prompt: "Create a clean standalone cinematic vintage family photograph for a premium automotive detailing website. A father stands beside a classic silver Porsche 356 with a young boy near him, late-1970s/early-1980s family-photo feeling, warm slightly faded analog colors, understated affluent European driveway, emotionally authentic but not melodramatic. This is an artistic placeholder, not a depiction of any known real person. NO text, NO typography, NO website UI, NO logos added, NO frame, NO polaroid border. Landscape photo, editorial quality, believable old print character while still usable as a clean web asset.",
  },
  {
    ...
    const generated = await Promise.all(
      SPECS.map(async (spec) => {
        ...
        return {
          ...
          validationStatus: spec.name === "michael-porsche-origin.jpg" ? "needs-customer-validation" as const : "approved-creative-direction" as const,
          source: spec.source,
        };
      })
    );
